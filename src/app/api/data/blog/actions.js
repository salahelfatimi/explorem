...
export const fetchBlogs = async (take) => {
  const blogs = [
    ...
    {
      _id: {
        $oid: "66364ac8fa53f12d2b9a9dff",
      },
      base64:
        "data:image/png;base64,",
      width: "2448",
      height: "3264",
      Org: "https://utfs.io/f/8b11ec24-211c-43b9-8dd7-11269be3b6dc-zgjs90.jpg",
      Url: "https://utfs.io/f/8b11ec24-211c-43b9-8dd7-11269be3b6dc-zgjs90.jpg",
      imageKey: "8b11ec24-211c-43b9-8dd7-11269be3b6dc-zgjs90.jpg",
...
export const fetchSingleBlog = async (title) => {
  const blogs = [
    ...
    },
    {
      ...
      width: "1758",
      height: "988",
      Org: "https://utfs.io/f/410eee4c-2880-4007-bbb7-033867d5e855-6tml77.png",
